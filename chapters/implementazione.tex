...
\begin{itemize}
	...
	\item \verb|stepsize_reg|, come accennato precedentemente, incide sul tempo di esecuzione
		...
		per shortest path e mincurv, mentre per mintime sono necessari valori $> 0.75$ per evitare di
...
corretto. Un esempio di questo caso è visibile all'immgine \ref{fig:norm-cross}. Durante le
